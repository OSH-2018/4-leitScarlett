/*
代码参考自https://github.com/paboldin/meltdown-exploit/blob/master/meltdown.c
和https://github.com/IAIK/meltdown
*/
#define _GNU_SOURCE
...
static void
set_cache_hit_threshold(void)//设置cache_hit_threshold时间
{
